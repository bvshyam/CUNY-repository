...
```{r include=FALSE,warning=FALSE, comment=FALSE, message=FALSE, tidy=TRUE, tidy.opts=list(width.cutoff=150)}
...
```{r include=FALSE, tidy=TRUE, tidy.opts=list(width.cutoff=80),echo=TRUE}
...
```{r include=FALSE,sfo-loaddata,eval=TRUE,warning=FALSE,tidy=TRUE, tidy.opts=list(width.cutoff=80)}
#JSON Load
...
```{r include=FALSE,sfo-datainsert,eval=TRUE,warning=FALSE,tidy=TRUE, tidy.opts=list(width.cutoff=80)}
...
```{r include=FALSE,sfo-houroffense,eval=TRUE,warning=FALSE,tidy=TRUE, tidy.opts=list(width.cutoff=80)}
...
```{r include=FALSE,sfodatefrequency,eval=TRUE,warning=FALSE,tidy=TRUE, tidy.opts=list(width.cutoff=80)}
...
```{r include=FALSE,sfo-timefrequency,eval=TRUE,warning=FALSE,tidy=TRUE, tidy.opts=list(width.cutoff=80)}
...
```{r include=FALSE,warning=FALSE, comment=FALSE, message=FALSE, tidy=TRUE, tidy.opts=list(width.cutoff=120), fig.width=10,fig.height=10}
...
```{r include=FALSE,eval = T, message=FALSE}
...
```{r include=FALSE,sfochart, eval = T}
...
```{r include=FALSE,sfo-removetables,eval=TRUE,warning=FALSE,tidy=TRUE, tidy.opts=list(width.cutoff=80)}

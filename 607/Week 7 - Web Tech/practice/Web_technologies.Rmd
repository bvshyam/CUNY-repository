...
xmlChildren(mailing_root)$body

xpathSApply(mailing_root,"//ul/li/p//a",xmlGetAttr,"href")


xpathSApply(mailing_root,"//table")

readHTMLTable(mailing_doc,which = 1) 
...
getGoogleURL <- function(search.term, domain = '.com', quotes=TRUE) 
    ...
    if(quotes) search.term <- paste('%22', search.term, '%22', sep='') 
        getGoogleURL <- paste('http://www.bing', domain, '/search?q=',
        search.term, sep='')
    }
...
#bing search
  ...
  cal_park_df <- data.frame(cal_park_links_filter)

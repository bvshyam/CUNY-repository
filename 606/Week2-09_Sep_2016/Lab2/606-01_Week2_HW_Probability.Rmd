---
title: "606-01_Week2_HW_Probability"
author: "Shyam BV"
...
```{r airlinerevenue,eval=TRUE}

##Total airline expected revenue for 120 passengers is 1884

## (120*.34)*25 + (120*.12)*35 +(120*.12)*25

## With the standard deviation of 19.95
```
...
This distribution has dual peak. The mean is centered around 25K to 49K.  

**(b) What is the probability that a randomly chosen US resident makes less than $50,000 per year?**

Probability that a randomly chosen US resident makes less than $50,000 per year is `r 96420486*(.022+.047+.158+.183+.212)/96420486`


**(c) What is the probability that a randomly chosen US resident makes less than $50,000 per year and is female? Note any assumptions you make.**

Randomly chosen US resident makes less than $50K are `r (.022+.047+.158+.183+.212)*.41`


**(d) The same data source indicates that 71.8% of females make less than $50,000 per year. Use this value to determine whether or not the assumption you made in part (c) is valid.**

If 71.8% females make less than 50K then `r .41*.718` is the total women make less than $50K. It is not equal to `r .41*.622`. So they are dependent.  

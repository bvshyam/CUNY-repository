...
**The distribution of area is right skewed. It is unimodel. Mean is around 1500. And SD is of `r sd(area)`**
...
**This sample distribution is little bit right skewed(It may vary on each sample). It is has a mean of `r mean(samp1)`. As the sample size is large enough, we can assume central limit therom for this sample** 
...
**`sample_means50` contains 5000 elements. The mean is `r mean(sample_means50)`. It is almost similar to the original dataset. 
...
** It has 100 elements and each element is the mean of 50 random samples.**
...
**The best point estimate of the population mean is 180796.1(this may vary)**
...
**The mean sale price from the sampling distribution of sample mean is 180896.7. The population mean is listed above Sample mean is almost the same of the population mean.**
  
  -   Change your sample size from 50 to 150, then compute the sampling 
distribution using the same method as above, and store these means in a  new vector called `sample_means150`. Describe the shape of this sampling distribution, and compare it to the sampling distribution for a sample size of 50.  Based on this sampling distribution, what would you guess to  be the mean sale price of homes in Ames?
